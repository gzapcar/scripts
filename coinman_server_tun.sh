...
echo -e "\033[32m- Añadiendo tun0 al bridge br-lan...\033[0m"
sed -i "/option name 'br-lan'/a \ \ \ \ list ports 'tun0'\n    option igmp_snooping '1'" /etc/config/network
check_status

echo -e "\033[32m- La interfaz tun0 ha sido añadida al bridge br-lan y se ha activado el IGMP snooping.\033[0m"
